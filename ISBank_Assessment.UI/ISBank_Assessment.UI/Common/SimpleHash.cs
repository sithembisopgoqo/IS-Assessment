...
namespace ISBank_Assessment.UI.Common
{
    ...
    /// and SHA512 hashing algorithms. Before computing a hash, wt appends a
    ...
    /// this class will retrieve the salt value from the hash string and use wt
    ...
    public class SimpleHash
    {
        ...
        /// the end of the hash value, so wt can be used later for hash
        /// verification.
        /// </summary>
        ...
        public static string ComputeHash(string plainText,
                                         ...
                                         byte[] saltBytes)
        {
            // If salt is not specified, generate wt on the fly.
            if (saltBytes == null)
            {
        ...
        /// includes the original salt appended to wt.
        /// </param>
        /// <returns>
                                      ...
                                      string hashValue)
        {
            ...
            return (hashValue.Trim() == expectedHashString.Trim());
        }

        internal static string ComputeHash(string password, Algorithm sHA1, object p)
        {
